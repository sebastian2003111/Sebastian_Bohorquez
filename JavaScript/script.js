...
const datosGuardados = localStorage.getItem('ContactoSebas');
if (datosGuardados){
...
if (botonVermas && bioCorta && bioCompleta) {
    botonVermas.addEventListener("click", () => {
        bioCompleta.classList.toggle("visible")
        bioCompleta.classList.toggle("oculto")
        bioCorta.classList.toggle("oculto")

        if (botonVermas.textContent === "Ver mas") {
